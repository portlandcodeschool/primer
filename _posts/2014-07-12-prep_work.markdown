...
1. Complete [Code Academy Web Fundamentals](http://www.codecademy.com/tracks/web) (est: 7 hours)
2. Work through the following (brief) sections of the Command Line Crash Course (est: 2 hours):
